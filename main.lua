...
function love.draw()
    ...
    if gameState == 'win' then
        ...
        love.graphics.printf(winningPlayer, 0, 10, VIRTUAL_WIDTH, 'center')
...
function collides(p, b)
   return not (p.x > b.x + BALL_SIZE or p.y > ball.y + BALL_SIZE or b.x > p.x + PADDLE_WIDTH or b.y > p.y + PADDLE_HEIGHT)
end
